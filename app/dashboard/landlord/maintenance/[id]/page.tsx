...
export default function LandlordMaintenanceDetailsPage() {
    ...
    <WithAuthProtection requiredRole="landlord">
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">View and manage maintenance request details</p>
        </div>

        <MaintenanceDetails requestId={requestId} />
      </div>
    </WithAuthProtection>
  )
}
