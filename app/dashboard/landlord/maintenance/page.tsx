...
const mockMaintenanceRequests = [
  ...
  },
  {
    ...
    property_name: "Rustic Countryside Cottage",
    room_name: "Bedroom",
...
export default function LandlordMaintenancePage() {
  ...
  const handleNewRequest = () => {
    ...
    router.push("/dashboard/landlord/maintenance/new")
  }

  const handleViewRequest = (id: string) => {
    router.push(`/dashboard/landlord/maintenance/${id}`)
  }
      ...
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground">View and manage maintenance requests for your properties</p>
          </div>
            ...
            {isLoading ? (
                  ...
                  <Card key={request.id} className="overflow-hidden">
                    ...
                    <CardContent className="pb-3">
                      ...
                      <div className="flex items-center mt-4 text-sm text-muted-foreground">
                        ...
                        <div>
                          <span className="text-xs">Tenant: {request.tenant_name}</span>
                        </div>
                      </div>
                    </CardContent>
                    <CardFooter>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    {activeTab === "all"
                      ? "There are no maintenance requests for your properties yet."
                ...
                <CardContent className="flex flex-col items-center justify-center py-10">
                  ...
                  <p className="text-center text-muted-foreground mb-6">
                    Need to create a maintenance request for one of your properties?
                    <br />
                    You can create a request on behalf of your tenants.
                  </p>
